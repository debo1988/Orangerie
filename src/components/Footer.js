				...
				<div className="container-fluid">
					<div className="row">
						<div className="col-8">
							...
							<ul class="list-group no-wrap">
  								<li class="list-group-item" style={{border:"none", color:"#17B794"}}>  
  								...
  								<li class="list-group-item" style={{border:"none",color:"#17B794"}}> 
									  ...
									  +97 254 546 4927 (WhatsApp)</li>
  								<li class="list-group-item" style={{border:"none",color:"#17B794"}}>				  
								  	<span className="footer-icon mr-2">
									 	<FaEnvelope className="footer-icon"/>
									</span>
									  cyprus4u@gmail.com</li>
  								<li class="list-group-item" style={{border:"none",color:"#17B794"}}>  
								  	<span className="footer-icon mr-2">
					...
					<div className="col-4">
						...
						<a href="http://technoparcsystems.com/" style={{color:"#17B794"}}> TechnoParc Systems</a>
					</div>
				</div>
			</div>
		</>
